...
<script>
  ...
  form.addEventListener('submit', function(e) {
    ...
    // 🔴 FIX: Se houver arquivos, pula o AJAX e usa o envio tradicional (Plano B)
    if (fileInput.files && fileInput.files.length > 0) {
        console.warn("Arquivos detectados. Forçando envio tradicional para garantir a anexação.");
