...
## Serviços de Consultoria Estatística
...
- **Acadêmico:** Suporte metodológico em **análises estatísticas** para Pesquisas (TCCs, Dissertações e Teses), com foco em reprodutibilidade e rigor científico.
...
### 📝 1. Solicitação
::: {.fragment .fade-in .p-3 .m-1 .rounded-4 .shadow-sm style="background-color: #18bc9c; color: white; font-weight: bold;"}
O cliente preenche o formulário para iniciar o contato.
:::

### 📞 2. Contato Ágil
::: {.fragment .fade-in .p-3 .m-1 .rounded-4 .shadow-sm style="background-color: #f5f5f5; color: #34495e; border: 1px solid #e0e0e0; font-weight: bold;"}
Respondo rapidamente via WhatsApp ou e-mail.
:::

### 🤝 3. Reunião
::: {.fragment .fade-in .p-3 .m-1 .rounded-4 .shadow-sm style="background-color: #f5f5f5; color: #34495e; border: 1px solid #e0e0e0; font-weight: bold;"}
Alinhamento de expectativas e escopo do projeto.
:::

### 💰 4. Proposta Comercial
::: {.fragment .fade-in .p-3 .m-1 .rounded-4 .shadow-sm style="background-color: #f5f5f5; color: #34495e; border: 1px solid #e0e0e0; font-weight: bold;"}
Documento formal com detalhes do serviço e orçamento.
:::

### 💻 5. Desenvolvimento
::: {.fragment .fade-in .p-3 .m-1 .rounded-4 .shadow-sm style="background-color: #f5f5f5; color: #34495e; border: 1px solid #e0e0e0; font-weight: bold;"}
Análise técnica, modelagem e codificação em R/Stan.
:::

### 🚀 6. Entrega Final
::: {.fragment .fade-in .p-3 .m-1 .rounded-4 .shadow-sm style="background-color: #2c3e50; color: white; font-weight: bold;"}
Relatórios finais e código-fonte, garantindo a reprodutibilidade.
:::
...
<script>
  ...
  form.addEventListener('submit', function(e) {
    ...
    // 🔴 FIX: Trata envio com arquivos. Exibe a mensagem de sucesso E força o envio tradicional
