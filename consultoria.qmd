...
%%| fig-height: 6
flowchart TD
    A[fa:file-pen 1. Solicitação] --> B[fa:whatsapp 2. Contato Ágil]
    B --> C[fa:handshake 3. Reunião]
    C --> D[fa:file-invoice-dollar 4. Proposta Comercial]
    D --> E[fa:laptop-code 5. Desenvolvimento]
    E --> F[fa:rocket 6. Entrega Final]
