...
flowchart TD
    ...
    B --> C["<i class='fa-solid fa-handshake'></i> 3. Reunião"]
    ...
    %% Estilo Premium: Fundos claros para o processo e cores ricas para início/fim
    ...
    linkStyle 0 stroke:#18bc9c; /* Seta Inicial em verde */
    linkStyle 4 stroke:#34495e; /* Seta Final em azul escuro */
```
