...
### Modelo de Mínimos Quadrados Generalizados
...
\mathbf{\Sigma}_i^{\text{CS}}
& = \sigma^2 \left( \mathbf{I} (1-\rho) + \mathbf{J} \rho \right) \\

& \text{Onde: } \\

\left[\mathbf{\Sigma}_i^{\text{CS}}\right]_{jk} =
\begin{cases}
\sigma^2, & \text{se } j = k \\
...
\mathbf{R}_i^{\text{CS}}
& = \mathbf{I} (1-\rho) + \mathbf{J} \rho \\

& \text{Onde: } \\

\left[\mathbf{R}_i^{\text{CS}}\right]_{jk} =
\begin{cases}
1, & \text{se } j = k \\
\rho, & \text{se } j \neq k
\end{cases}
