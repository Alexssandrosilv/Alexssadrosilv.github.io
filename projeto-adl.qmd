...
Note que, para todos os indivíduos temos $n_{i} = 8$ (dados balanceados), ou seja, cada indivíduo possui 8 observações ao longo do tempo.
...
-   **Passo 1 - Leitura:** Importação da base de dados brutos para o ambiente R.
