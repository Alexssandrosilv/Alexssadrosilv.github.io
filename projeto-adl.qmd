...
nomes <- c("Sujeito", "Grupo", "Semana 1", "Semana 2", "Semana 3", 
           "Semana 4", "Semana 5", "Semana 6", "Semana 7", "Semana 8")

# Passo 1: Leitura e Renomeação: bd_stroke (Wide)
bd_stroke <- gsheet::gsheet2tbl(url_stroke) %>% stats::setNames(novos_nomes) 

tabela_interativa(dados = bd_stroke,
                  titulo_tabela = "Dados Brutos de Recuperação de Pacientes Pós-AVC (formato largo)")
