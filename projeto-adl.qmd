...
## Preparação da base de dados: Recuperação de Pacientes Pós-AVC (STROKE)
...
DT::datatable(
  ...
  caption = htmltools::tags$caption(
    ...
    htmltools::strong("Tabela 1:  Dados de Recuperação de Pacientes Pós-AVC (Dados Brutos - formato largo (Wide))")
  ),
  class = "hover",
  options = list(
...
DT::datatable(
  ...
  caption = htmltools::tags$caption(
    style = "caption-side: top; text-align: center; color:#40916c;",
    htmltools::strong("Tabela 1:  Dados Longitudinais de Recuperação de Pacientes Pós-AVC (formato longo (Longe)*)")
  ),
