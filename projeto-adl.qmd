...
Definição dos índices no estudo:
...
tabela_interativa(dados = bd_stroke,
                  titulo_tabela = "Dados Brutos de Recuperação de Pacientes Pós-AVC")
...
```{r}
#| label: Descritiva dados brutos
#| code-summary: "Descritiva dados brutos"
...
```{r}
#| label: Descritiva dados reestruturados
#| code-summary: "Descritiva dados reestruturados"
