...
```{r}
#| label: Modelo com estrutura de correlação/covariância autorregressiva (AR1) 
#| code-summary: "Modelo com estrutura de correlação/covariância autorregressiva (AR1)"
