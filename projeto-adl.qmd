...
Veja bem, cada $Y_{ij}$ (Resposta) esta associada a um tempo $t_{ij}$, a resposta observada para o indivíduo $i$ será representada por um vetor coluna de dimensão $n_i \times 1$.
...
De forma análoga, podemos escrever o vetor de respostas $Y_{i}$ para o i-ésimo indivíduo.
